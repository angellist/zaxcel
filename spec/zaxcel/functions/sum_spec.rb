...
RSpec.describe Zaxcel::Functions::Sum do
  ...
  # End-to-end: build a workbook, serialize it to a real .xlsx, and read the formulas back out of
  # the worksheet XML — the same path Excel walks when opening the file.
